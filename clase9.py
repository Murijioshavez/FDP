...
print('Hola, yo soy Mauricio Chavez y esta es mi solucion a ordenar listas sin bucles, map, filter, compresion de listas, etc. espero le guste el codigo, me esforce bastante investigando nuevos metodos para resolverlo, uwu.\n',resultado)